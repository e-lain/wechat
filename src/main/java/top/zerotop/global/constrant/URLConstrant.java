...
public class URLConstrant {
	 ...
	 */
	//添加素材
	public static final String URL_MATERIAL_ADD_MATERIAL =  BASE_URL + "/material/add_material?access_token=";
	//添加图文素材
	public static final String URL_MATERIAL_ADD_NEWS = BASE_URL + "/material/add_news?access_token=";
	//获取素材列表
	public static final String URL_MATERIAL_BATCHGET_MATERIAL = BASE_URL + "/material/batchget_material?access_token=";
	//获取素材
	public static final String URL_MATERIAL_GET_MATERIAL = BASE_URL + "/material/get_material?access_token=";
	//更新图文素材
	public static final String URL_MATERIAL_UPDATE_NEWS = BASE_URL + "/material/update_news?access_token=";
	
	/**
	 * menu
	 */
	public static final String URL_MENU_CREATE = BASE_URL + "/menu/create?access_token=";
	 ...
	 * follower
	 */
	public static final String URL_FOLLOWER_GET = BASE_URL + "/user/get?access_token=";
